    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sustainable_alternative', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session_type', models.CharField(choices=[('video', 'Video Call'), ('chat', 'Chat'), ('voice', 'Voice Call')], max_length=20)),
